        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="m-1 w-3/4">
              ...
              <div className="mb-3">
                {photo ? (
                  <div className="text-center">
                    <img src={URL.createObjectURL(photo)} alt="product_photo" className="h-auto max-w-full" />
                  </div>
                ) : (
                  <div className="text-center">
                    <img src={photo ? URL.createObjectURL(photo) : productPhoto} alt="product_photo" className="h-auto max-w-full" />
                  </div>
                )}
              </div>
              ...
              <div className="mb-3">
                <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={handelUpdate}>
                  Update Product
                </button>
              </div>
              <div className="mb-3">
                <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={handelDelete}>
                  Delete Product
                </button>
              </div>
            </div>
