    ...
    <Layout>
      <div className="flex mt-6 space-x-8 px-4">
        ...
        <div className="w-1/6 border-r pr-4">
          ...
          <Radio.Group className="flex flex-col space-y-2" onChange={(e) => setRadio(e.target.value)}>
            {Prices.map((p) => (
          ...
          <button onClick={() => window.location.reload()} className="mt-8 bg-red-600 hover:bg-red-700 text-white py-2 rounded w-full font-semibold">
            Reset Filter
          </button>
        </div>
